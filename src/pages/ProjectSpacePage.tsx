...
const ProjectSpacePage = () => {
  ...
  return (
    <div className={cn(
      "fixed inset-x-0 top-0 h-[100dvh] pt-[env(safe-area-inset-top)] lg:pt-16 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-900/20 via-background to-background flex flex-col z-40",
