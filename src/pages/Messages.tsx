...
const Messages = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-background">
      {/* Desktop Layout */}
      <div className="hidden lg:flex h-full pt-16">
        <ResizablePanelGroup
      ...
      {/* Mobile Layout */}
      <div className="flex lg:hidden h-full flex-col pt-16 pb-16">
        {!selectedThreadId ? (
          ...
          <ChatWindow threadId={selectedThreadId} onBack={() => setSelectedThreadId(null)} />
        )}
      </div>
    </div>
  );
