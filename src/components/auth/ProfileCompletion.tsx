                ...
                <div className="bg-card border border-border rounded-lg p-6 shadow-lg">
                    ...
                    {step === 0 && (
                        <div className="space-y-6">
                            ...
                            {accountType && (
                                <div className={`rounded-lg p-3 text-xs border ${accountType === 'fan' ? 'bg-blue-500/10 border-blue-500/30 text-blue-400' : accountType === 'studio' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400' : 'bg-amber-500/10 border-amber-500/30 text-amber-400'}`}>
                                    {accountType === 'fan'
                                        ? '🎬 As a Fan you can like, comment, follow creators, rate content, and join public discussion spaces anonymously.'
                                        : accountType === 'studio'
                                        ? '🏢 As a Studio/Company you can post jobs, search for vendors, hire creators, and manage professional film projects.'
